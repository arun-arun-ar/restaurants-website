                        ...
                        >
                            <div className="p-6">
                                <img
                                    src={member.image}
                                    alt={member.name}
                                    className="w-48 h-48 object-cover rounded-full mx-auto border-4 border-amber-400 hover:border-amber-500 transition-colors duration-300"
                                />
                                <div className="mt-6">
                                    <h3 className="text-xl font-semibold text-gray-900">{member.name}</h3>
                                    <p className="text-amber-500 text-sm mt-2">{member.role}</p>
                                </div>
